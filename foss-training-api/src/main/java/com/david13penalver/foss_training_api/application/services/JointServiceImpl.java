...
import com.david13penalver.foss_training_api.domain.ports.in.JointService;
import com.david13penalver.foss_training_api.domain.ports.out.JointRepository;
...
public class JointServiceImpl implements JointService {
    ...
    public Joint save(Joint joint) {
        log.debug("Saving joint: {}", joint.getName());
