package com.david13penalver.foss_training_api.application.services;
...
import com.david13penalver.foss_training_api.domain.ports.in.MovementPatternService;
import com.david13penalver.foss_training_api.domain.ports.out.MovementPatternRepository;
...
public class MovementPatternServiceImpl implements MovementPatternService {
    ...
    public MovementPattern save(MovementPattern movementPattern) {
        log.debug("Saving movement pattern: {}", movementPattern.getName());
