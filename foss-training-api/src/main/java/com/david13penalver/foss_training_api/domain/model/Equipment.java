...
public enum Equipment {
    ...
    BACK_EXTENSION("Back Extension Machine", "Hyperextension for lower back and glutes", EquipmentCategory.MACHINES),
    ASSISTED_PULL_UP("Assisted Pull-up Machine", "Counterbalanced pull-up/chin-up assistance",
            EquipmentCategory.MACHINES),

    // Weight Machines - Shoulders
    SHOULDER_PRESS("Shoulder Press Machine", "Overhead pressing for deltoid development", EquipmentCategory.MACHINES),
    ...
    PENDULUM_SQUAT("Pendulum Squat Machine", "Arc-motion squat for deep quad activation", EquipmentCategory.MACHINES),

    // Weight Machines - Calves
    STANDING_CALF_RAISE("Standing Calf Raise Machine", "Vertical calf raise for gastrocnemius",
            EquipmentCategory.MACHINES),
    SEATED_CALF_RAISE("Seated Calf Raise Machine", "Seated calf raise targeting soleus", EquipmentCategory.MACHINES),
